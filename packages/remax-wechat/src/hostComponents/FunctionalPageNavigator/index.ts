 ...
 */
export const FunctionalPageNavigator: React.ComponentType<FunctionalPageNavigatorProps> =
  createHostComponent<FunctionalPageNavigatorProps>('functional-page-navigator');
