...
var _unmountRefHooks = _interopRequireDefault(__webpack_require__(64));
function _default(initValue) {
  var _useState = (0, _react.useState)(initValue),
    _useState2 = (0, _slicedToArray2.default)(_useState, 2),
    state = _useState2[0],
    setState = _useState2[1];
  var ref = (0, _react.useRef)(initValue);
  var unmountRef = (0, _unmountRefHooks.default)();
  var outSetState = (0, _react.useCallback)(function (state) {
    if (!unmountRef.current) {
      setState(state);
    }
    ref.current = state;
  }, [unmountRef]);
  return [state, outSetState, ref];
}
...
var arrayWithHoles = __webpack_require__(59);
var iterableToArrayLimit = __webpack_require__(60);
